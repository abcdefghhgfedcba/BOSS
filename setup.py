...
setup(
    ...
    entry_points={'console_scripts': (
        ...
        'gradient-ascent-robust=design_baselines.'
        'gradient_ascent_robust.experiments:cli',
        ...
        'gradient-ascent-min-ensemble-robust=design_baselines.'
        'gradient_ascent_robust.min_ensemble_experiments:cli',
        ...
        'gradient-ascent-mean-ensemble-robust=design_baselines.'
        'gradient_ascent_robust.mean_ensemble_experiments:cli',
        ...
        'mins-robust=design_baselines.'
        'mins_robust.experiments:cli',
        ...
        'cbas-robust=design_baselines.'
        'cbas_robust.experiments:cli',
        ...
        'autofocused-cbas-robust=design_baselines.'
        'autofocused_cbas_robust.experiments:cli',
        ...
        'cma-es-robust=design_baselines.'
        'cma_es_robust.experiments:cli',
        ...
        'bo-qei-robust=design_baselines.'
        'bo_qei_robust.experiments:cli',
        ...
        'reinforce-robust=design_baselines.'
        'reinforce_robust.experiments:cli',
