...
from design_baselines.mins_robust.replay_buffer import ReplayBuffer
from design_baselines.mins_robust.trainers import Ensemble
from design_baselines.mins_robust.trainers import WeightedGAN
from design_baselines.mins_robust.nets import ForwardModel
from design_baselines.mins_robust.nets import Discriminator
from design_baselines.mins_robust.nets import DiscreteGenerator
from design_baselines.mins_robust.nets import ContinuousGenerator
from design_baselines.mins_robust.nets import ConvDiscriminator
from design_baselines.mins_robust.nets import DiscreteConvGenerator
from design_baselines.mins_robust.nets import ContinuousConvGenerator
from design_baselines.mins_robust.nets import PhiGammaModel
from design_baselines.mins_robust.utils import get_weights
from design_baselines.mins_robust.utils import get_synthetic_data
...
def mins_robust(config):
    """Optimize a design problem score using the algorithm MINS_robust
    ...
    hacked = dict()
    hacked = load_object(hacked, config["path_hacked_task"])
    task = hacked['task']
    ...
    hack['task'] = task
    hack['config'] = config
    hack['solution'] = solution.numpy()
    save_object(hack, os.path.join(config["logging_dir"], f"hacked.dat"))
