...
from design_baselines.coms_cleaned_robust.trainers import ConservativeObjectiveModel
from design_baselines.coms_cleaned_robust.trainers import VAETrainer
from design_baselines.coms_cleaned_robust.nets import ForwardModel
from design_baselines.coms_cleaned_robust.nets import SequentialVAE
from design_baselines.coms_cleaned_robust.nets import PhiGammaModel
...
def coms_cleaned_robust(
    ...
    hacked = dict()
    hacked = load_object(hacked, params["path_hacked_task"])
    task = hacked['task']
