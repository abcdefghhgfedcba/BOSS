...
def make_table(dir, percentile, modifier, group, normalize):
    ...
    baselines = [
        ...
        "cma-es-robust",
        "gradient-ascent",
        "gradient-ascent-robust",
        "gradient-ascent-mean-ensemble",
        "gradient-ascent-mean-ensemble-robust",
        "gradient-ascent-min-ensemble",
        "gradient-ascent-min-ensemble-robust",
        "mins",
        "mins-robust",
        "reinforce",
        "reinforce-robust",
    ...
    baseline_to_tag = {
        ...
        "autofocused-cbas-robust": [f"score/{percentile}"],
        "cbas": [f"score/{percentile}"],
        "cbas-robust": [f"score/{percentile}"],
        "bo-qei": [f"score/{percentile}"],
        "bo-qei-robust": [f"score/{percentile}"],
        "cma-es": [f"score/{percentile}"],
        "cma-es-robust": [f"score/{percentile}"],
        "gradient-ascent": [f"score/{percentile}"],
        "gradient-ascent-robust": [f"score/{percentile}"],
        "gradient-ascent-mean-ensemble": [f"score/{percentile}"],
        "gradient-ascent-mean-ensemble-robust": [f"score/{percentile}"],
        "gradient-ascent-min-ensemble": [f"score/{percentile}"],
        "gradient-ascent-min-ensemble-robust": [f"score/{percentile}"],
        "mins": [f"exploitation/actual_ys/{percentile}", f"score/{percentile}"],
        "mins-robust": [f"exploitation/actual_ys/{percentile}", f"score/{percentile}"],
        "reinforce": [f"score/{percentile}"],
        "reinforce-robust": [f"score/{percentile}"],
        "coms": [f"score/{percentile}"],
        "coms-robust": [f"score/{percentile}"]
    }

    baseline_to_iteration = {
        "autofocused-cbas": 20,
        "autofocused-cbas-robust": 20,
        "cbas": 20,
        "cbas-robust": 20,
        "bo-qei": 10,
        "bo-qei-robust": 10,
        ...
        "cma-es-robust": 0,
        "gradient-ascent": 200,
        "gradient-ascent-robust": 200,
        "gradient-ascent-mean-ensemble": 200,
        "gradient-ascent-mean-ensemble-robust": 200,
        "gradient-ascent-min-ensemble": 200,
        "gradient-ascent-min-ensemble-robust": 200,
        "mins": 0,
        "mins-robust": 0,
        "reinforce": 200,
        "reinforce-robust": 200,
        "coms": 50,
        "coms-robust": 50
    }
