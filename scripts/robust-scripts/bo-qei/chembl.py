...
path_origin = 'results/baselines/bo-qei-chembl/bo_qei_2023-08-28_14-48-57'
      ...
      for omega_sigma_init in [1e-3]:
            for folder in os.listdir(path_origin):
                if os.path.isdir(os.path.join(path_origin, folder)):
                    ...
                    os.system(f'CUDA_VISIBLE_DEVICES=0 bo-qei-robust chembl --local-dir results/SIRO/bo-qei-robust/chembl --cpus 5 \
                        --gpus 1 \
                        --num-parallel 1 \
                        --num-samples 1 \
                        --omega_mu_init 0. \
